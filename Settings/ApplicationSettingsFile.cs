...
namespace SmartSystemMenu.Settings
{
    static class ApplicationSettingsFile
    {
        public static ApplicationSettings Read(string fileName, string languageFileName)
        {
            ...
            var selectMonitorElement = document.XPathSelectElement("/smartSystemMenu/mover/select");
            settings.SelectMonitor = ReadShortcut(selectMonitorElement);
        ...
        public static void Save(string fileName, ApplicationSettings settings)
        {
            ...
            document.Add(new XElement("smartSystemMenu",
                                 ...
                                 new XElement("mover",
                                     ...
                                     new XElement("select",
                                         new XAttribute("key1", settings.SelectMonitor.Key1 == VirtualKeyModifier.None ? string.Empty : ((int)settings.SelectMonitor.Key1).ToString()),
                                         new XAttribute("key2", settings.SelectMonitor.Key2 == VirtualKeyModifier.None ? string.Empty : ((int)settings.SelectMonitor.Key2).ToString()),
                                         new XAttribute("key3", settings.SelectMonitor.Key3 == VirtualKey.None ? string.Empty : ((int)settings.SelectMonitor.Key3).ToString()))
                                 ),
                                 new XElement("closer",
