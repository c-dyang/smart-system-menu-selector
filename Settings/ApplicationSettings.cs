...
namespace SmartSystemMenu.Settings
{
    public class ApplicationSettings : ICloneable
    {
        ...
        public KeyboardShortcut SelectMonitor { get; set; }
        ...
        public ApplicationSettings()
        {
            ...
            SelectMonitor = new KeyboardShortcut();
            // 默认热键：Win+Shift+N 弹出显示器选择器（key1=WinL, key2=Shift, key3=N）
            SelectMonitor.Key1 = VirtualKeyModifier.WinL;
            SelectMonitor.Key2 = VirtualKeyModifier.Shift;
            SelectMonitor.Key3 = VirtualKey.VK_N;
        }
        ...
        public object Clone()
        {
            ...
            settings.SelectMonitor = (KeyboardShortcut)SelectMonitor.Clone();
            return settings;
        }
        ...
        public bool Equals(ApplicationSettings other)
        {
            ...
            if (SelectMonitor.Key1 != other.SelectMonitor.Key1 || SelectMonitor.Key2 != other.SelectMonitor.Key2 || SelectMonitor.Key3 != other.SelectMonitor.Key3)
            {
                return false;
            }
